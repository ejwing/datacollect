...
def download_realestate(year:int, seasion:int):
    url = "http://plvr.land.moi.gov.tw/DownloadSeason?season=" + str(year) + "S" + str(seasion) + "&type=zip&fileName=lvr_landcsv.zip"
    return download_file(url, "tempfile")
